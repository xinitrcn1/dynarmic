...
struct A64EmitContext final : public EmitContext {
    A64EmitContext(const A64::UserConfig& conf, RegAlloc& reg_alloc, IR::Block& block, EmitContext::SharedLabelList& shared_labels);
...
//data
    ...
    EmitContext::SharedLabelList shared_labels;
